                ...
                Container( // container to house the carousel
                  ...
                  child: ListView.builder( // displays carousel in a list view and allowing user to scroll through the list
                    ...
                    itemBuilder: (BuildContext context, int index){
                      ...
                      return GestureDetector( // so that the carousel is clickable
                        onTap: () {
                          Navigator.push(
                            context, 
                            MaterialPageRoute(
                              builder: (_) => DestinationScreen(destination: destination) // so that when the carousel is clicked it will direct the user to the destination_screen.dart page
                          ));
                        },

                        child: Container( // container to host containers for each container destination
